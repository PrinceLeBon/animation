...
class DifficultOne extends StatefulWidget {
  const DifficultOne({super.key});

  @override
  State<DifficultOne> createState() => _DifficultOneState();
}

class _DifficultOneState extends State<DifficultOne> {
...
class PictureCCard extends StatelessWidget {
