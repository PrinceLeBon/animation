...
class _AnimatedGridSampleState extends State<AnimatedGridSample> {
  ...
  List<Map<String, dynamic>> items = [
    ...
    {'id': '18', 'name': 'G', 'width': 100},
    {'id': '19', 'name': 'G', 'width': 100},
    {'id': '20', 'name': 'G', 'width': 100},
    {'id': '21', 'name': 'G', 'width': 100},
    {'id': '22', 'name': 'G', 'width': 100},
  ];
                ...
                child: Wrap(
                  ...
                  children: List.generate(items.length, (index) {
                    ...
                    return AnimatedContainer(
                        ...
                        width: isMarkedForDelete ? 0 : 60,
                        //change depending on font size or content
